...
Die Idee ist es per SFunctionContinous eine Regelung zu simulieren. 
Die Werte die für phi berechnet werden dann in eine csv datei zu schreiben.
Die dann von von OpenGL visualisiert werden.
